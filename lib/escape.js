...
function escapeFilename(str, transform){
  return escapeDiacritic(escapePath(str, transform));
}

function escapePath(str, transform){
  ...
  return transformString(result, transform);
}
...
exports.filename = escapeFilename;
exports.path = escapePath;
exports.regex = escapeRegex;
exports.diacritic = escapeDiacritic;
