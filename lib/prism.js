...
function PrismUtil(str, options = {}) {
  ...
  // Shift Line Numbers ('firstLine' option) should only be added under preprocess mode
  // https://prismjs.com/plugins/line-numbers/
  if (lineNumber && firstLine && !isPreprocess) preTagAttrArr.push(`data-start="${firstLine}"`);

  // Line Highlight ('mark' option) should only be added under preprocess mode
  // https://prismjs.com/plugins/line-highlight/
  if (mark && !isPreprocess) preTagAttrArr.push(`data-line="${mark}"`);
